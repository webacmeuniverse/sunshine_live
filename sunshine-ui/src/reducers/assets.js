...
export default function assetReducer(state = {
  ...
  switch (action.type) {
    ...
    case GET_SINGLE_ASSET_FAILURE:
      ...
      case GET_SINGLE_ASSET_ENERGY_CERTIFICATE:
      return Object.assign({}, state, {
        //isFetchingSingle: true,
        //singleAssetReady: false
      });
    case GET_SINGLE_ASSET_ENERGY_CERTIFICATE_SUCCESS:
      return Object.assign({}, state, {
        //isFetchingSingle: false,
       // singleAssetReady: true,
       singleAssetEnergyCertificate: action.payload,
       // registered: ''
      });
      
    case GET_SINGLE_ASSET_ENERGY_CERTIFICATE_FAILURE:
      return Object.assign({}, state, {
       // isFetchingSingle: false,
        //singleAssetReady: false,
        error: action.payload.error,
