import {
  ...
  ALL_ORGANIZATIONS_REQUEST, ALL_ORGANIZATIONS_SUCCESS, ALL_OSSLIST_SUCCESS,ALL_OSSLIST_FAILURE,ALL_ORGANIZATIONS_FAILURE,
  ...
  THEIR_ORGANIZATIONS_REQUEST, THEIR_ORGANIZATIONS_SUCCESS, THEIR_ORGANIZATIONS_FAILURE,SET_ALL_OSSLIST_NUMBER,
...
export default function organizationReducer(state = {
  ...
  switch (action.type) {
    ...
    case ALL_ORGANIZATIONS_SUCCESS:
      ...
      case SET_ALL_OSSLIST_NUMBER:
      return {
        ...state,
        allOSSListNumber: parseInt(action.payload, 10),
      };
    case ALL_OSSLIST_SUCCESS:
        return {
          ...state,
          isFetchingList: false,
          allOrganizationsReady: true,
          allOSSList: action.payload,
        }; 
    case ALL_OSSLIST_FAILURE:
          return {
            ...state,
            allOrganizationsReady: true,
            isFetchingList: false,
