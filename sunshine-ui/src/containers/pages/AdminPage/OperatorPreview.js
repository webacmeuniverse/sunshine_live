...
import OperatorPreviewView from '../../../containers/pages/AdminPage/OnboardingPreview/Operator/MarketOperator';


class OperatorPreview extends React.Component {
  componentDidMount() {
         ...
         <Helmet  >
          ...
          <MobileNavContainer/>
           <div className="flex">
              ...
              {userdata.superuser == false ?<TopBar pageTitleAction="/oss/onboarding/operator" subTitleAction=""  pageTitle='translations:ossMenu.Operator' subTitle='translations:ossMenu.Preview'/> :
                                            <TopBar pageTitleAction="/oss/onboarding/operator" subTitleAction="" pageTitle='translations:ossMenu.Operator' subTitle='translations:ossMenu.Preview'/>
                                    }
