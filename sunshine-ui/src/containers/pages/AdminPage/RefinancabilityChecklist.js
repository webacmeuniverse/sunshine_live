...
import RefinancabilityChecklistPreview from '../../../containers/pages/AdminPage/RefinancabilityChecklistPreview/EESRefinancabilityChecklist';


class RefinancabilityChecklist extends React.Component {
  componentDidMount() {
         ...
         <Helmet  >
          ...
          <MobileNavContainer/>
           <div className="flex">
              ...
              {userdata.superuser == false ?<TopBar pageTitleAction="/oss/simulation/refinancability-Checklist" subTitleAction=""  pageTitle='translations:ossMenu.EESRefinanceabilityChecklist' subTitle='translations:ossMenu.Preview'/> :
                                            <TopBar pageTitleAction="/oss/simulation/refinancability-Checklist" subTitleAction="" pageTitle='translations:ossMenu.EESRefinanceabilityChecklist' subTitle='translations:ossMenu.Preview'/>
                                    }
                   ...
                   <div className="col-span-12">
                        <section style={{ marginTop: '10px',marginBottom:'0px' }}    >
                          <div className="container oss-admin h-auto">
                                <RefinancabilityChecklistPreview/>       
                          </div>
                        </section>
                      </div>
                    </div>
...
RefinancabilityChecklist.propTypes = {};
