...
import OnboardingPreviewView from '../../../containers/pages/AdminPage/OnboardingPreview/OnboardingResident';


class OnboardingPreview extends React.Component {
  componentDidMount() {
         ...
         <Helmet  >
          ...
          <MobileNavContainer/>
           <div className="flex">
              ...
              {userdata.superuser == false ?<TopBar pageTitleAction="/oss/onboarding/residents" subTitleAction=""  pageTitle='translations:ossMenu.Onboarding' subTitle='translations:ossMenu.Preview'/> :
                                            <TopBar pageTitleAction="/onboarding" subTitleAction="" pageTitle='translations:ossMenu.Onboarding' subTitle='translations:ossMenu.Preview'/>
                                    }
