                                                       ...
                                                       {this.state.fetching
                                                              ...
                                                              <>
                                                                ...
                                                                <div className="tab-pane active show" id="tabt-1">
                                                                            ...
                                                                            <div className="content-style2  mt-5">
                                                                                    ...
                                                                                    <div className=" mb-5">
                                                                                        ...
                                                                                        <div style={{fontWeight: '500',fontSize: '20px'}}>
                                                                                            Let's see how we can facilitate your renovation journey!
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className=" mb-5" style={{border: '1px solid #6b728030',padding: '20px'}}>
                                                                                        <div style={{fontSize: '16px',fontFamily: 'Inter',fontWeight: '400',color: '#6B7280',fontFamily: "'Inter', sans-serif"}}>
                                                                                            Here is a quick diagnostic quiz that will allow you to analyse the needs of your home. Tell us how you feel at home through a series of questions and, at the end, we'll outline where you could potentially improve your home.
                                                                                    ...
                                                                                    <div className="d-block">
                                                                                        <button className="btn btn-primary btn-md btn-default welcomeButtone" onClick={() => this.props.handleNextStepNew()}
                                                                                            style={{ fontSize: '12px'}}>Let's start!</button>
                                                                                    </div>
                                                                       ...
                                                                       <h2 className="mb-5 mt-5">Let's start with some basic information</h2>
