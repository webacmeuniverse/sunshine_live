        ...
        return (
                    ...
                    <tr key={index}>
                        <td >  <DeleteIcon  style={{ width: '2em',height: '2em'}}onClick={() => props.deleteResultRow(menu.data.ID)} /></td>
                         ...
                         <textarea  className="input mt-2" id={result_title} name="result_title" onBlur={(e) => props.resultValueUpdate(e,menu.data.ID,index,'Table 1')}  style={{width: '150px',fontWeight: '900',border: 'none',borderBottom: '0.89246px solid #BFD4E4'}} rows="4" cols="50">{menu.data.result_title}</textarea>
                        ...
                        <ReactTags className="input mt-2"
                                            ...
                                            onAddition={(e) =>props.onAddition(e,'cost_vat_xcl',menu.data.ID,index) } minQueryLength={1}  />
                        ...
                        <td ><input type="text" className="input mt-2" id={unit_vat_xcl} name="unit_vat_xcl" defaultValue={menu.data.unit_vat_xcl} onBlur={(e) => props.resultValueUpdate(e,menu.data.ID,index,'Table 1')}  style={{width: '60px',fontWeight: '900',borderWidth: '1px' ,border: 'none',borderBottom: '0.89246px solid #BFD4E4'}}  /></td>
                        
                        <td ><input type="text" className="input mt-2" id={vat} name="vat"  defaultValue={menu.data.vat} onBlur={(e) => props.resultValueUpdate(e,menu.data.ID,index,'Table 1')} style={{width: '60px',fontWeight: '900',borderWidth: '1px' ,border: 'none',borderBottom: '0.89246px solid #BFD4E4'}}  /></td>
                        ...
                        <ReactTags className="input mt-2"
                                            ...
                                            onAddition={(e) =>props.onAddition(e,'cost_vat_inc',menu.data.ID,index) }minQueryLength={1}  />
                        ...
                        <ReactTags className="input mt-2"
                                            ...
                                            onAddition={(e) =>props.onAddition(e,'total_vat_xcl',menu.data.ID,index) } minQueryLength={1}  />
                        ...
                        <ReactTags className="input mt-2"
                                            ...
                                            onAddition={(e) =>props.onAddition(e,'total_vat_inc',menu.data.ID,index) } minQueryLength={1}  />
