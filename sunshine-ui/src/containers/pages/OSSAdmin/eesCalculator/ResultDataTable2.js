        ...
        return (               
                    <tr key={index}>
                        <td >  <DeleteIcon  style={{ width: '2em',height: '2em'}}onClick={() => props.deleteResultRow(menu.data.ID)} /></td>
                         <td style={{ width: '20%'}}><input type="text" className="input mt-2" id={result_title} name="result_title" onBlur={(e) => props.resultValueUpdate(e,menu.data.ID,index,'Before')} defaultValue={menu.data.result_title} style={{width: '100%',fontSize: '15px',fontWeight: '900',borderWidth: '1px' ,border: 'none',borderBottom: '0.89246px solid #BFD4E4'}}  /></td>                      
                        <td style={{ width: '30%'}}> 
