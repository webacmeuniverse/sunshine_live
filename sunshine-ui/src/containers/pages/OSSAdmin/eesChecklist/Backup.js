...
class EESCalculatorView extends React.Component {
  ...
  fetch(ENDPOINTS.SERVER + '/backup/step/question/field/options?oss_admin_id='+this.props.userdata.email+'&menu_type='+this.state.filter_type, config)
      .then(res => res.json())
     // .then((result) => result.length ? JSON.parse(text) : {})
      .then(
          (result) => {
      ...
      <React.Fragment>
        ...
        <div className="flex">
          ...
          <div className="content oss-admin">
            <TopBar userdata={userdata} pageTitle='Simulation Tools' subTitle='Backup'/>
                                ...
                                <table className="table table-report sm:mt-2">
                                    <thead>
                                        ...
                                        <th className="whitespace-no-wrap" style={{ border: 'none' }}>Date Time</th>
                                            ...
                                            <th className="text-left whitespace-no-wrap" style={{ border: 'none' }}>Action</th>
                                    ...
                                    {this.state.userDataList.map((userInfo,userInfoKey, arr) => {
                                            ...
                                            <td style={{ border:'none' }}> {userInfo.menu_type}</td>
