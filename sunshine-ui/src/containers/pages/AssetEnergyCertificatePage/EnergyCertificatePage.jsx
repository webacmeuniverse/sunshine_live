...
import AssetPublicView from '../../../components/asset/AssetPublicView/PublicEnergyCertificateInfo';
import {withTranslation, useTranslation } from 'react-i18next';

function EnergyCertificatePage(props) {
  const {
    alerts,
  } = props;
  const { t } = useTranslation('translations');
  let menu_path = window.location.pathname.split('/')[3];
  return (
    <React.Fragment>
          ...
          <MobileNavContainer/>
            <div className="flex">
                    ...
                    <div className="content oss-admin">
                      <TopBar pageTitleAction={'/asset/' + menu_path} subTitleAction=""  pageTitle={t('translations:ossMenu.Assets')} subTitle='EnergyCertificate'/>
...
}))(withTranslation('translations')(EnergyCertificatePage) );
