          ...
          <MobileNavContainer/>
            <div className="flex">
                    ...
                    <div className="content oss-admin">
                      <TopBar pageTitleAction="/assets" subTitleAction=""  pageTitle={t('translations:ossMenu.Assets')} subTitle={t('translations:ossMenu.AssetDetails')}/>
...
}))(withTranslation('translations')(AssetPage) );
