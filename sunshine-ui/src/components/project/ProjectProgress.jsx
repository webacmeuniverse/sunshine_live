                    ...
                    <ListItem key={milestone.milestoneEnum}>
                      ...
                      <ListItemText
                        primary={
                          <React.Fragment>
                            <ListItemAvatar>
                      {progress.icon} {milestone.label}
                    </ListItemAvatar>  <span>{progress.progress.toFixed(2)}% {t('milestones.complete')}</span>
                          </React.Fragment>
                        }
                        secondary={progress.missingFiles?.length > 0 && (
                          <React.Fragment>
                            ...
                            <ol className={classes.missingFilesList} style={{ paddingLeft: '18px'}}>
