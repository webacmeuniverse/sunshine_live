                                    ...
                                    <div className={classes.container}>
                                        <List disablePadding>
                                            <div className={`row ${classes.header}`}>
                                                ...
                                                >
                                                    <MeetingsListFullScreen style={{fontSize: '0.975rem'}}
                                                        meetings={meetings}
                                                        viewOnly={viewOnly}
                                                        handleOpenCloseDelete={this.handleOpenCloseDelete}
                                                    />
                                                    <Button style={{fontSize: '0.575rem'}}
                                            ...
                                            <div className={`row ${classes.subHeader}`} style={{ marginLeft:"0px",marginLeft: '0px',marginRight: '0px' }}>
