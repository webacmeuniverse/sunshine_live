...
const menuItems = [
  ...
  
  {
    ...
    items: [
      ...
      // {
      //   titleKey: "EES Checklist",
      //   items: [
      //     {
      //       titleKey: "Sustainability",
      //       url: "/oss/ees-checklist/sustainability",
      //       exact: true,
      //       icon: <HomeIcon />,
      //     },
      //     {
      //       titleKey: "Standard Renovation Packages",
      //       url: "/oss/ees-checklist/standard-renovation-packages",
      //       exact: true,
      //       icon: <HomeIcon />,
      //     },
      //     {
      //       titleKey: "Contract",
      //       url: "/oss/ees-checklist/contract",
      //       exact: true,
      //       icon: <HomeIcon />,
      //     },
      //     {
      //       titleKey: "Measurement/Verification of the project",
      //       url: "/oss/ees-checklist/measurement-project",
      //       exact: true,
      //       icon: <HomeIcon />,
      //     }
      //   ]
