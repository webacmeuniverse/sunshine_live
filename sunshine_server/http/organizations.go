...
func (o *org) findPartner(w http.ResponseWriter, r *http.Request) {
	orgs, err := o.c.FindMyPartner(r.Context(), r.Body)
	if err != nil {
		writeError(w, r, err)
		return
	}

	w.Header().Add("Location", path.Join(r.URL.String(), models.Organization{}.Kind()))
