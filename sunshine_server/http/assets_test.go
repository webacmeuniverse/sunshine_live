...
func testAssetDeleteASCII(t *testing.T) {
	...
	org := stores.NewTestOrg(t, e.OrganizationStore, stores.TOwithLEAR(usr.ID))
...
func testAssetGet(t *testing.T) {
	var (
		...
		lear = stores.NewTestUser(t, e.UserStore)
		o    = stores.NewTestOrg(t, e.OrganizationStore, stores.TOwithLEAR(lear.ID))
...
func testAssetListByUser(t *testing.T) {
	...
	user := stores.NewTestUser(t, e.UserStore)
	o2 := stores.NewTestOrg(t, e.OrganizationStore, stores.TOwithLEAR(user.ID))
	o1 := stores.NewTestOrg(t, e.OrganizationStore, stores.TOwithLEAR(user.ID))
