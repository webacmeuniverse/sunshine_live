...
\begin{center}
	\begin{tabu}{|X[2]|X|}\tabucline{}
		Contract number: \iffalse input fields.contract_id value="{{.Contract.Fields.contract_id}}" \fi {{.Contract.Fields.contract_id}} & Date: {{index .Contract.Fields "date"}} \\\tabucline{} %chktex 26
	\end{tabu}
\end{center}
