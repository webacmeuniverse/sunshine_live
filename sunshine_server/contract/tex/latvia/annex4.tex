...
\begin{enumerate}
	\item Bāzlīnijas novērtēšanas periods ietver ikmēneša datus par šādiem gadiem: [$gads^{n-2}$, $gads^{n-1}$ un $gads^n$]

\begin{enumerate}
\item Enerģētiskie dati Bāzlīnijas novērtēšanas periodā:
...
\item Bāzlīnija (izejas dati)

\begin{enumerate}
	\item Bāzlīnija tiek noteikta, balsoties uz enerģijas datiem un apstākļiem Bāzlīnijas novērtēšanas periodā saskaņā ar turpmāk norādīto:
\end{enumerate}
...
\item Garantētais enerģijas ietaupījums un Garantētais enerģijas patēriņš
