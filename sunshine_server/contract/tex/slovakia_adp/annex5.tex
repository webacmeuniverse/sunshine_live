...
\begin{center}
	\begin{tabu}{|X[3]|X|X|X|X|} \tabucline{} \rowfont[c]\bfseries
		{{$tt := period "en" .periodic_maint_activities_covered_by_contractor}} % chktex 26
...
\begin{center}
	\begin{tabu}{|X[3]|X|X|X|X|} \tabucline{} \rowfont[c]\bfseries
		{{$tt := period "en" .mid_term_preventative_activity}} % chktex 26
		{{with $t := translate "en" $tt}}
		{{.Columns | column}} \\\tabucline{}
		{{range .Rows}} % chktex 26
		{{rowfmt $t .}} \\\tabucline{}
...
\begin{center}
	\begin{tabu}{|X[3]|X|X|X|X|} \tabucline{} \rowfont[c]\bfseries
		{{$tt := period "en" .long_term_provisioned_activities}} % chktex 26
		{{with $t := translate "en" $tt}}
		{{.Columns | column}} \\\tabucline{}
		{{range .Rows}} % chktex 26
		{{rowfmt $t .}} \\\tabucline{}
...
\begin{center}
	\begin{tabu}{|X[3]|X|X|X|X|} \tabucline{} \rowfont[c]\bfseries
		{{$tt := period "en" .reccomended_maintanance_activity}} % chktex 26
		{{with $t := translate "en" $tt }}
		{{.Columns | column}} \\\tabucline{}
		{{range .Rows}} %chktex 26
		{{rowfmt $t .}} \\\tabucline{}
