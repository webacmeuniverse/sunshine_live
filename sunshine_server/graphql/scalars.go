...
func UnmarshalUserAction(v interface{}) (models.UserAction, error) {
	...
	case "ASSIGN_RESIDENCY":
		return models.UserActionAssignResidency, nil
	case "GDPR":
	...
	case "PROJECT_CREATE_ORG":
		return models.UserActionProjectCreateOrg, nil
	case "PROJECT_CREATE_ASSET":
		return models.UserActionProjectCreateAsset, nil
	case "ADVANCE_MILESTONE":
		return models.UserActionAdvanceMilestone, nil
	case "ADVANCE_TO_WORK_PHASE":
		return models.UserActionAdvanceToWorkPhase, nil
	case "ADVANCE_TO_MONITORING_PHASE":
		return models.UserActionAdvanceToMonitoringPhase, nil
	case "TABLE_UPDATE":
		return models.UserActionTableUpdate, nil
	default:
...
func UnmarshalFAReviewType(v interface{}) (models.FAReviewType, error) {
	...
	case "EPC":
		return models.FAReviewTypeEPC, nil
	default:
		return 0, fmt.Errorf("%[1]T(%[1]v) is not string", v)
	}
}
...
func MarshalUploadType(ut models.UploadType) graphql.Marshaler {
	return graphql.MarshalString(string(ut))
}

func UnmarshalUploadType(v interface{}) (models.UploadType, error) {
	ut, _ := v.(models.UploadType)
...
func UnmarshalMeetingType(v interface{}) (models.MeetingType, error) {
	...
	case "ACQUISITION_ACQUISITION_COMMITMENT":
		return models.MTypeAcquisitionAcquisitionCommitment, nil
...
var (
	...
	meetingTopicMap = map[models.MeetingType]string{
		...
		models.MTypeAcquisitionAcquisitionCommitment: "ACQUISITION_ACQUISITION_COMMITMENT",
