...
func NewTestOrg(t *testing.T, s Store, opts ...TOpts) *models.Document {
	t.Helper()
	...
	o := models.Organization{
		...
		Valid:              models.ValidationStatusValid,
		Country:            models.CountryLatvia,
		RegistrationNumber: time.Now().String(),
	}
	...
	d, err = orgS.Update(context.Background(), d)
	if err != nil {
...
func TOwithLEAR(id uuid.UUID) TOpts {
	return func(t *testing.T, st Store, d *models.Document) {
		org := *d.Data.(*models.Organization)
		for i, or := range org.OrganizationRoles {
			if or.Position != "lear" {
				continue
			}
			d.Data.(*models.Organization).OrganizationRoles[i].UserID = id
			d.Data.(*models.Organization).Roles.LEAR = id
		}
	}
}

func TOwithLEAA(id uuid.UUID) TOpts {
	return func(t *testing.T, st Store, d *models.Document) {
		d.Data.(*models.Organization).OrganizationRoles = append(d.Data.(*models.Organization).OrganizationRoles, models.OrganizationRole{
			UserID:         id,
			OrganizationID: d.Data.(*models.Organization).ID,
			Position:       "leaa"})
		d.Data.(*models.Organization).Roles.LEAAs = append(d.Data.(*models.Organization).Roles.LEAAs, id)
	}
}

func TOwithMember(id uuid.UUID) TOpts {
	return func(t *testing.T, st Store, d *models.Document) {
		d.Data.(*models.Organization).OrganizationRoles = append(d.Data.(*models.Organization).OrganizationRoles, models.OrganizationRole{
			UserID:         id,
			OrganizationID: d.Data.(*models.Organization).ID,
			Position:       "member"})
		d.Data.(*models.Organization).Roles.Members = append(d.Data.(*models.Organization).Roles.Members, id)
	}
}
...
func NewTestAttachment(t *testing.T, st Store, id uuid.UUID, ut string) *models.Attachment {
	t.Helper()

	att := models.Attachment{
		Name:       "new-attachment",
		Owner:      id,
		UploadType: models.UploadType(ut),
		Size:       int64(1024),
	}
