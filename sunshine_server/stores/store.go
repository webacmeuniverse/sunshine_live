...
type Store interface {
	...
	// Get document by given email where applicable
	GetByEmail(ctx context.Context, email string) (*models.Document, error)

	// GetByID of a given user
	GetByID(ctx context.Context, userID string) (*models.Document, error)

	// ListSteps using menu_type, oss_admin and lang and order created_at ascending
	ListSteps(context.Context, Filter) ([]models.Document, Dependencies, int, error)

	// ListSteps using menu_type, oss_admin and lang and order created_at ascending
	ListUserDataSteps(context.Context, Filter) ([]models.Document, Dependencies, int, error)
	...
	// ListBySession all documents matching Filter. This method preloads dependencies.
	ListBySession(context.Context, Filter) ([]models.Document, Dependencies, int, error)

	// ListByOssAdminID all documents matching Filter. This method preloads dependencies.
	ListByOssAdminID(context.Context, Filter) ([]models.Document, Dependencies, int, error)

	// ListByOssAdminMenuType all documents matching Filter. This method preloads dependencies.
	ListByOssAdminMenuType(context.Context, Filter) ([]models.Document, Dependencies, int, error)

	// ListBackups all documents matching Filter. This method preloads dependencies.
	ListBackups(context.Context, Filter) ([]models.Document, Dependencies, int, error)
