...
type Portfolio interface {
	...
	GetPortfolioNoRole(context.Context, models.Country) (uuid.UUID, error)
	...
	// GetAllAdminNWManagers returns list of user ids that are admin network managers
	GetAllAdminNWManagers(ctx context.Context) ([]uuid.UUID, error)
}
