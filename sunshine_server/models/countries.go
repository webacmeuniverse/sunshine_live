...
func (c Country) IsConsortium() bool {
	switch c {
	case CountryAustria, CountryBulgaria, CountryLatvia, CountryPoland, CountryRomania, CountrySlovakia, CountryGermany, CountryItaly, CountryPortugal:
		return true
	default:
		return false
	}
...
func (c Country) HasAdaptedContract() bool {
	switch c {
	case CountryBulgaria, CountryRomania, CountrySlovakia:
		return true
	default:
		return false
	}
