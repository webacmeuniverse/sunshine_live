...
type User struct {
	...
	IsOssAdmin      bool    `json:"is_oss_admin" gorm:"column:is_oss_admin"`
	CellPhoneNo     string  `json:"cell_phone_no"`
	...
	OrganizationServices []OrganizationServices `json:"organization_services"`
}
...
type OrganizationServices struct {
	...
	ServicesProvided bool   `json:"services_provided"`
	ShortSummary     bool   `json:"short_summary"`
}
