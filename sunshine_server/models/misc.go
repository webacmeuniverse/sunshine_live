...
func (f LegalForm) String() string {
	...
	case LegalFormProfessional:
		return "Professional"
	case LegalFormCraftsman:
		return "Craftsman"
	case LegalFormOperator:
		return "Operator"
	case LegalFormOSS:
		return "OSS"
	default:
...
const (
	...
	MTypeAcquisitionAcquisitionCommitment MeetingType = "acquisition_acquisition_commitment"
...
const (
	...
	UserActionAssignResidency              UserAction = "assign_residency"
	...
	UserActionProjectCreateOrg             UserAction = "project_create_org"
	UserActionProjectCreateAsset           UserAction = "project_create_asset"
	UserActionAdvanceMilestone             UserAction = "advance_milestone"
	UserActionAdvanceToWorkPhase           UserAction = "advance_to_work_phase"
	UserActionAdvanceToMonitoringPhase     UserAction = "advance_to_monitoring_phase"
	UserActionTableUpdate                  UserAction = "table_update"
)
...
const (
	...
	WorkPhaseT       EntityType = "work_phase"
	MonitoringPhaseT EntityType = "monitoring_phase"
)
