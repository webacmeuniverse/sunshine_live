...
type Project struct {
	...
	EPCSigned bool `json:"epc_signed" gorm:"epc_signed"`
	FASigned  bool `json:"fa_signed" gorm:"fa_signed"`

	TotalInvestment float64 `json:"total_investment" gorm:"total_investment"`
	EnergySavings   float64 `json:"energy_savings" gorm:"energy_savings"`
}
...
// RoleProject is the Project of a Role.
type RoleProject struct {
	ID   uuid.UUID
	Name string `json:"name"`
}

// TableName returns RoleProject's table name.
...
type ProjectRole struct {
	...
	Project   RoleProject `json:"project" gorm:"foreignKey:ProjectID;association_autoupdate:false" `
